...
class Building:
    ...
    def run_elevator(self, elevator_number, destination_floor):
        ...
        final_floor = elevator.go_to_floor(destination_floor)
        return final_floor
...
if __name__ == "__main__":
    ...
    final_floor_0 = my_building.run_elevator(0, 5)
    print(f"Elevator 0 final floor: {final_floor_0}")

    # Run elevator 1 to the 8th floor
    final_floor_1 = my_building.run_elevator(1, 8)
    print(f"Elevator 1 final floor: {final_floor_1}")
